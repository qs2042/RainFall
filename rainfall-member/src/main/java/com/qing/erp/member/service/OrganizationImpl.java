...
import com.qing.erp.member.dao.OrganizationDao;
...
public class OrganizationImpl implements IOrganizationService {
    ...
    @Override
    public OrganizationEntity add(OrganizationEntity entity) {
        entity.setId(null);
    ...
    @Override
    public OrganizationEntity queryOne(Integer id) {
        return id == null ? null : dao.findById(id).get();
    }

    @Override
    public Page<OrganizationEntity> queryPage(Integer page, Integer show) {
