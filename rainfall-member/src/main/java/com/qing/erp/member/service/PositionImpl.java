...
import com.qing.erp.member.dao.PositionDao;
...
public class PositionImpl implements IPositionService {
    ...
    @Override
    public PositionEntity update(PositionEntity entity) {
    ...
    @Override
    public PositionEntity queryOne(Integer id) {
        return id == null ? null : dao.findById(id).get();
    }

    @Override
    public Page<PositionEntity> queryPage(Integer page, Integer show) {
