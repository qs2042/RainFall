...
import com.qing.erp.member.service.UserInventoryImpl;
// 动态类
...
public class UserInventoryController {
    @Autowired
    private UserInventoryImpl impl;

    @PostMapping("/add")
    public R add(UserInventoryEntity entity) {
    ...
    @PostMapping("/update")
    public R update(UserInventoryEntity entity) {
