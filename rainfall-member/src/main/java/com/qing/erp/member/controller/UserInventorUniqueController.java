...
import com.qing.erp.member.service.UserInventorUniqueImpl;
// 动态类
...
*/
@RequestMapping("/userInventorUnique")
@RestController
public class UserInventorUniqueController {
    @Autowired
    private UserInventorUniqueImpl impl;

    @PostMapping("/add")
    public R add(UserInventorUniqueEntity entity) {
    ...
    @PostMapping("/update")
    public R update(UserInventorUniqueEntity entity) {
