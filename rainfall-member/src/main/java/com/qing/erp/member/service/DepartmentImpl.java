...
import com.qing.erp.member.dao.DepartmentDao;
...
public class DepartmentImpl implements IDepartmentService {
    ...
    @Override
    public DepartmentEntity add(DepartmentEntity entity) {
        entity.setId(null);
    ...
    @Override
    public DepartmentEntity queryOne(Integer id) {
        return id == null ? null : dao.findById(id).get();
    }

    @Override
    public Page<DepartmentEntity> queryPage(Integer page, Integer show) {
