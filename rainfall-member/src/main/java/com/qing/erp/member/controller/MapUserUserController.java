...
import com.qing.erp.member.service.MapUserUserImpl;
// 动态类
...
*/
@RequestMapping("/mapUserUser")
@RestController
public class MapUserUserController {
    @Autowired
    private MapUserUserImpl impl;

    @PostMapping("/add")
    public R add(MapUserUserEntity entity) {
    ...
    @PostMapping("/update")
    public R update(MapUserUserEntity entity) {
