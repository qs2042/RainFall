...
import com.qing.erp.member.service.MapUserRoleImpl;
...
public class MapUserRoleController {
    @Autowired
    private MapUserRoleImpl impl;

    @PostMapping("/add")
    public R add(MapUserRoleEntity entity) {
    ...
    @PostMapping("/update")
    public R update(MapUserRoleEntity entity) {
