...
import com.qing.erp.member.service.MapUserPositionImpl;
...
*/
@RequestMapping("/mapUserPosition")
@RestController
public class MapUserPositionController {
    @Autowired
    private MapUserPositionImpl impl;

    @PostMapping("/add")
    public R add(MapUserPositionEntity entity) {
    ...
    @PostMapping("/update")
    public R update(MapUserPositionEntity entity) {
