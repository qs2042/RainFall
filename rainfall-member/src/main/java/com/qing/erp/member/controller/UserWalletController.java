...
import com.qing.erp.member.service.UserWalletImpl;
// 动态类
...
public class UserWalletController {
    @Autowired
    private UserWalletImpl impl;

    @PostMapping("/add")
    public R add(UserWalletEntity entity) {
    ...
    @PostMapping("/update")
    public R update(UserWalletEntity entity) {
