...
import com.qing.erp.member.service.MapRolePermissionImpl;
...
*/
@RequestMapping("/mapRolePermission")
@RestController
public class MapRolePermissionController {
    @Autowired
    private MapRolePermissionImpl impl;

    @PostMapping("/add")
    public R add(MapRolePermissionEntity entity) {
    ...
    @PostMapping("/update")
    public R update(MapRolePermissionEntity entity) {
